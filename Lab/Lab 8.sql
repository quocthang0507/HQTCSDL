...
CREATE DATABASE QLThuVien ON 
(
	NAME = QLThVi,
	FILENAME = 'D:\OneDrive\Thang\HOCTAP\2019-2020\HKI\HQTCSDL\Lab\QLThVi.MDF',
	SIZE = 10 MB,
	MAXSIZE = 50 MB,
	FILEGROWTH = 5 MB
) 
...
(
	NAME = QLThVi_LOG,
	FILENAME = 'D:\OneDrive\Thang\HOCTAP\2019-2020\HKI\HQTCSDL\Lab\QLThVi_LOG.LDF',
	SIZE = 5 MB,
	MAXSIZE = 25 MB,
	FILEGROWTH = 5 MB
)
...
ALTER TABLE [NHANVIEN]  WITH NOCHECK 
ADD	CONSTRAINT [FK_NHANVIEN_BANGCAP] FOREIGN KEY([MaBangCap]) REFERENCES [BANGCAP] ([MaBangCap])		
ON UPDATE CASCADE		
ON DELETE CASCADE		
GO		
...
WITH CHECK ADD CONSTRAINT [FK_PHIEUTHUTIEN_DOCGIA] FOREIGN KEY([MaDocGia]) REFERENCES [DOCGIA] ([MaDocGia])
GO
...
ALTER TABLE [PHIEUMUONSACH] WITH CHECK
ADD CONSTRAINT [FK_PHIEUMUONSACH_DOCGIA] FOREIGN KEY([MaDocGia]) REFERENCES [DOCGIA] ([MaDocGia])
ON UPDATE CASCADE
ON DELETE CASCADE
GO
...
ALTER TABLE [CHITIETPHIEUMUON] WITH CHECK
ADD	CONSTRAINT [FK_CHITIETPHIEUMUON_PHIEUMUONSACH] FOREIGN KEY([MaPhieuMuon]) REFERENCES [PHIEUMUONSACH] ([MaPhieuMuon])
GO
